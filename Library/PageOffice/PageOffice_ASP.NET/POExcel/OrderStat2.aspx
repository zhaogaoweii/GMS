<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderStat2.aspx.cs" Inherits="OrderStat2" %>
    ...
    <div class="zz-content mc clearfix pd-28">
        ...
        <div class="zz-contentLeft fl">
            <ul class="left-ul">
                ...
                <li style="background: #d0eaf7; display: block;"><a href="OrderStat2.aspx">查询表</a></li>
